...
var _city = __webpack_require__(125);

var _city2 = _interopRequireDefault(_city);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var areaid = returnCitySN["cid"];
var cityid = areaid.substr(0, 4) + '00';
var cityname = _city2.default[cityid];
var provinceid = areaid.substr(0, 2) + '0000';
var provincename = _city2.default[provinceid];
...
var alertTips = {
    tips: function tips(txt) {
        var divObj = document.createElement("div");
        divObj.innerHTML = txt;
        divObj.setAttribute('class', 'tipspop');
...
exports.default = {
    ...
    postA: function postA(url, params, success) {
        return axios({
            method: 'post',
            url: url,
            params: params,
    ...
    postB: function postB(url, params, success) {
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/_css-loader@0.28.11@css-loader/index.js!../../node_modules/_sass-loader@6.0.7@sass-loader/lib/loader.js!./common.scss", function() {
			var newContent = require("!!../../node_modules/_css-loader@0.28.11@css-loader/index.js!../../node_modules/_sass-loader@6.0.7@sass-loader/lib/loader.js!./common.scss");
...
// module
exports.push([module.i, "@charset \"UTF-8\";\n* {\n  box-sizing: border-box; }\n\nhtml, body, div, span, object, iframe,\nh1, h2, h3, h4, h5, h6, p, blockquote, pre,\nabbr, address, cite, code,\ndel, dfn, em, img, ins, kbd, q, samp,\nsmall, strong, sub, sup, var,\nb, i,\ndl, dt, dd, ol, ul, li,\nfieldset, form, label, legend,\ntable, caption, tbody, tfoot, thead, tr, th, td,\narticle, aside, canvas, details, figcaption, figure,\nfooter, header, hgroup, menu, nav, section, summary,\ntime, mark, audio, video {\n  margin: 0;\n  padding: 0;\n  border: 0;\n  outline: 0;\n  font-size: 100%;\n  vertical-align: baseline;\n  background: transparent; }\n\nhtml,\nbody {\n  background-color: #f8f8f8; }\n\nul, ol {\n  list-style: none; }\n\n/* 公共样式 */\n.fl {\n  float: left; }\n\n.fr {\n  float: right; }\n\n.tl {\n  text-align: left; }\n\n.tc {\n  text-align: center; }\n\n.tr {\n  text-align: right; }\n\n.fw {\n  font-weight: 700; }\n\n.dn {\n  display: none; }\n\n.db {\n  display: block; }\n\n.dlb {\n  display: inline-block; }\n\n.mgt20 {\n  margin-top: 20px; }\n\n.app-wraper {\n  width: 100%;\n  margin: 0 auto; }\n  .app-wraper .header-outer {\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100px; }\n  .app-wraper .chinese-title {\n    height: 40px;\n    line-height: 40px;\n    color: #000;\n    font-size: 26px;\n    text-align: center;\n    letter-spacing: 5px; }\n  .app-wraper .english-title {\n    height: 40px;\n    line-height: 40px;\n    color: #AEAEAE;\n    font-size: 14px;\n    text-align: center;\n    letter-spacing: 12px; }\n\n.module-box {\n  padding: 40px 0;\n  margin: 0 auto; }\n\n.flex-outer {\n  display: flex;\n  width: 100%;\n  height: 100%; }\n  .flex-outer .flex-inner {\n    flex: 1; }\n\n.table-box-outer {\n  display: table;\n  width: 100%;\n  height: 100%; }\n  .table-box-outer .table-box-inner {\n    display: table-cell;\n    vertical-align: middle; }\n\n/* 英文名 - 中文名 - 描述 */\n.eng-name {\n  color: #D7D7D7;\n  font-size: 12px; }\n\n.cha-name {\n  padding: 15px 0 10px;\n  color: #020202;\n  font-size: 16px;\n  font-weight: 700; }\n\n.item-desc {\n  color: #8A8A8A;\n  font-size: 14px; }\n\n.fixed-show-enter-active, .fixed-show-leave-active {\n  transition: all .5s ease; }\n\n.fixed-show-enter, .fixed-show-leave-to {\n  opacity: 0; }\n\n/* 轮播 */\n.slide-item-box {\n  position: relative;\n  width: 100%;\n  height: 100%;\n  transition-duration: 800ms; }\n\n.slide-item {\n  float: left;\n  width: 100%;\n  height: 100%; }\n\n.slide-bar {\n  position: absolute;\n  bottom: 0;\n  left: 0;\n  width: 100%;\n  padding: 20px 0;\n  text-align: center; }\n  .slide-bar .bar-icon {\n    display: inline-block;\n    width: 10px;\n    height: 10px;\n    border-radius: 10px;\n    margin: 0 5px;\n    background: rgba(102, 102, 102, 0.5); }\n    .slide-bar .bar-icon:hover {\n      background: rgba(102, 102, 102, 0.8); }\n    .slide-bar .bar-icon.on {\n      background: #fff; }\n      .slide-bar .bar-icon.on:hover {\n        background: #fff; }\n\n/*自定义滚动条*/\n::-webkit-scrollbar {\n  width: 9px;\n  height: 9px; }\n\n::-webkit-scrollbar-thumb {\n  background-color: #b0c0d0;\n  border-radius: 4px; }\n\n::-webkit-scrollbar-thumb:hover {\n  background-color: #CDD9E6; }\n\n::-webkit-scrollbar-thumb:active {\n  background-color: #b0c0d0; }\n\n::-webkit-scrollbar-track-piece {\n  background-color: transparent; }\n\n.tipspop {\n  position: fixed;\n  top: 50%;\n  left: 50%;\n  padding: 30px 50px;\n  border-radius: 10px;\n  transform: translate(-50%, -50%);\n  color: #fff;\n  background-color: rgba(0, 0, 0, 0.6);\n  z-index: 1000; }\n", ""]);
...
exports.default = {
    ...
    methods: {
        resumeClick: function resumeClick() {
            alert('对不起，近期在维护中，会马上更新');
        }
    },
    created: function created() {},
    mounted: function mounted() {
        $("#foot_btn").trigger("click");
    ...
    watch: {
        // 'params':{
        //     handler(curValue, oldval){
        //         if(this.isPoneAvailable(this.params.telephone)){
...
// import Swiper from '../third/swiper/swiper.min.js'
//
//
//
//
...
exports.default = {
    ...
    data: function data() {
        return {
            activeIndex: 0, // 点亮的位置         
            navlist: [{ title: '首页', url: '/' }, { title: '关于我们', url: 'aboutus.html' }, { title: '业务介绍', url: 'business.html' }]
        };
    },
...
exports.default = {
    ...
    methods: {
        goToTopClick: function goToTopClick() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_2_vue_loader_lib_selector_type_script_index_0_home_vue__ = __webpack_require__(180);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_2_vue_loader_lib_template_compiler_index_id_data_v_27094d26_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_2_vue_loader_lib_selector_type_template_index_0_home_vue__ = __webpack_require__(391);
var disposed = false
...
/* scopeId */
var __vue_scopeId__ = "data-v-27094d26"
/* moduleIdentifier (server only) */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_2_vue_loader_lib_template_compiler_index_id_data_v_27094d26_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_2_vue_loader_lib_selector_type_template_index_0_home_vue__["a" /* default */],
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-27094d26", Component.options)
  } else {
    hotAPI.reload("data-v-27094d26", Component.options)
  }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(14)("1b621958", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
// module
exports.push([module.i, "\n#top[data-v-27094d26] {\n  background: #fff;\n}\n#foot[data-v-27094d26] {\n  width: 100%;\n}\n#foot_btn[data-v-27094d26] {\n  position: fixed;\n  bottom: 10px;\n  left: 100000000px;\n}\n", ""]);
...
var render = function() {
  ...
  return _c("div", { staticClass: "app-wraper" }, [
    _c(
      "header",
      {
        ...
        _c("div", { staticClass: "container" }, [
          ...
          _c(
            "nav",
            {
              ...
              attrs: { id: "bs-navbar", "aria-expanded": "true" }
            },
            [
              _c("ul", { staticClass: "nav navbar-nav" }, [
                _c("li", [
                  _c("a", { on: { click: _vm.resumeClick } }, [
                    _vm._v("JavaScript和es6")
                  ])
                ]),
                _vm._v(" "),
                _c("li", { staticClass: "active" }, [
                  _c("a", { on: { click: _vm.resumeClick } }, [_vm._v("vue")])
                ]),
                _vm._v(" "),
                _c("li", [
                  _c("a", { on: { click: _vm.resumeClick } }, [
                ...
                _vm._v(" "),
                _c("li", [
                  _c("a", { on: { click: _vm.resumeClick } }, [_vm._v("html5")])
                ]),
                _vm._v(" "),
                _c("li", [
                  _c("a", { on: { click: _vm.resumeClick } }, [_vm._v("css3")])
                ])
              ]),
              _vm._v(" "),
              _vm._m(1)
    ...
    _c("div", { attrs: { id: "foot" } }, [
      _c(
        "button",
        {
          staticClass: "btn btn-primary my-btn",
          staticStyle: { dispaly: "none" },
          attrs: {
            id: "foot_btn",
            type: "button",
            "data-toggle": "modal",
                ...
                _c("div", { staticClass: "modal-body" }, [
                  _c("div", { staticStyle: { "padding-left": "20px" } }, [
                    _c(
                      ...
                      [
                        _vm._v(
                          "1:本交流站由以下技术构成，特别鸣谢它们可以天天随意的摧残让我在无聊的日子瞎折腾"
                        )
                      ]
                    ),
                    _vm._v(" "),
...
var staticRenderFns = [
        ...
        _c(
          "a",
          {
            attrs: {
              ...
              onclick:
                "_hmt.push(['_trackEvent', 'docv3-navbar', 'click', 'V3导航-Bootstrap中文网'])",
              target: "_blank"
            }
          },
          [_vm._v("个人简历")]
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticStyle: { height: "40px" } }, [
      _c("span", { staticClass: "label label-default" }, [_vm._v("jquey")]),
      _vm._v(" "),
      _c("span", { staticClass: "label label-warning" }, [_vm._v("bootstrap")]),
      _vm._v(" "),
      _c("span", { staticClass: "label label-primary" }, [_vm._v("vue")]),
      _vm._v(" "),
      _c("span", { staticClass: "label label-success" }, [_vm._v("webpack")])
    ])
  },
  function() {
    var _vm = this
    ...
    return _c("div", { staticStyle: { height: "40px" } }, [
      ...
      _vm._v(" "),
      _c("span", { staticClass: "label label-warning" }, [_vm._v("vue")]),
      _vm._v(" "),
      _c("span", { staticClass: "label label-primary" }, [_vm._v("webpack")]),
      _vm._v(" "),
      _c("span", { staticClass: "label label-success" }, [_vm._v("html5")]),
      _vm._v(" "),
      _c("span", { staticClass: "label label-primary" }, [_vm._v("css3")])
    ])
  },
  function() {
    var _vm = this
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-27094d26", esExports)
  }
}
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(11), __webpack_require__(53).setImmediate))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_2_vue_loader_lib_template_compiler_index_id_data_v_0f66b2fc_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_2_vue_loader_lib_selector_type_template_index_0_header_vue__ = __webpack_require__(59);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
// module
exports.push([module.i, "\n.myheader[data-v-0f66b2fc] {\n  width: 100%;\n  height: 130px;\n  border: 1px solid transparent;\n  border-color: transparent;\n  border-color: rgba(255, 255, 255, 0.1);\n  line-height: 100px;\n  padding: 0 60px;\n  padding-top: 27px;\n}\n.imgstyle[data-v-0f66b2fc] {\n  border: 1px solid transparent;\n  border-color: transparent;\n  border-color: rgba(0, 0, 0, 0.1);\n}\n.myheader .logo[data-v-0f66b2fc] {\n  float: left;\n  max-width: 200px;\n}\n.header_nav[data-v-0f66b2fc] {\n  position: absolute;\n  right: 34%;\n  /*float: right;*/\n}\n.header_nav ul li[data-v-0f66b2fc] {\n  float: left;\n  height: 100px;\n  list-style: none;\n  width: 140px;\n  text-align: center;\n}\n.header_nav ul li a[data-v-0f66b2fc] {\n    display: inline-block;\n    width: 70px;\n    margin: 0 auto;\n    cursor: pointer;\n    color: #fff;\n    text-decoration: none;\n}\n.act[data-v-0f66b2fc] {\n  border-bottom: 4px solid #fff;\n}\n.white-bg .act[data-v-0f66b2fc] {\n  border-bottom: 4px solid black;\n}\n.header_nav ul li.white-bg a[data-v-0f66b2fc] {\n  color: #666;\n}\n.header_nav ul:hover a[data-v-0f66b2fc] {\n  border-bottom-width: 0;\n}\n.header_nav ul li:hover a[data-v-0f66b2fc] {\n  border-bottom: 4px solid #fff;\n}\n.header_nav ul li.white-bg:hover a[data-v-0f66b2fc] {\n  border-bottom: 4px solid black;\n}\n.nav_but[data-v-0f66b2fc] {\n  width: 130px;\n  display: inline-block;\n  height: 40px;\n  line-height: 40px;\n  border-radius: 80px;\n  letter-spacing: 2px;\n  background: #A92523;\n  color: #fff;\n  cursor: pointer;\n}\n", ""]);
...
var render = function() {
  ...
  return _c("div", { staticClass: "header-wraper" }, [
    _c("div", { staticClass: "myheader", class: { imgstyle: !_vm.imgstyle } }, [
      _c("div", { staticClass: "logo" }, [
        ...
        !_vm.imgstyle
          ? _c("img", {
              staticStyle: { color: "red" },
              attrs: { src: __webpack_require__(61) }
            })
          : _vm._e()
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "header_nav" }, [
        _c(
          ...
          _vm._l(_vm.navlist, function(item, index) {
            return _c("li", { class: { "white-bg": _vm.activeIndex == 1 } }, [
              _c(
                "a",
                {
                  class: { act: index == _vm.activeIndex },
                  attrs: { href: item.url }
                },
...
module.exports = "data:image/png;base64,"
...
module.exports = "data:image/png;base64,"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_2_vue_loader_lib_template_compiler_index_id_data_v_246fa73c_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_2_vue_loader_lib_selector_type_template_index_0_footer_vue__ = __webpack_require__(66);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
// module
exports.push([module.i, "\n.footer[data-v-246fa73c] {\n  height: 178px;\n  width: 100%;\n  background-color: #191919;\n  color: #fff;\n  line-height: 178px;\n}\n.footer_content[data-v-246fa73c] {\n  width: 1170px;\n  padding-right: 120px;\n  margin: 0 auto;\n}\n.footer_content span[data-v-246fa73c] {\n  dispaly: inline-block;\n  font-size: 14px;\n}\n.footer_content span img[data-v-246fa73c] {\n  dispaly: inline-block;\n}\n.footer_left[data-v-246fa73c] {\n  float: left;\n  font-size: 14px;\n  color: #FFFFFF;\n  text-align: left;\n}\n.footer_right[data-v-246fa73c] {\n  float: right;\n  right: 20px;\n  bottom: 190px;\n  font-size: 14px;\n  color: #FFFFFF;\n  text-align: left;\n  display: inline-block;\n  height: 30px;\n  line-height: 30px;\n  margin-top: 70px;\n}\n.reback-top[data-v-246fa73c] {\n  display: inline-block;\n  position: fixed;\n  right: 20px;\n  bottom: 190px;\n  font-size: 14px;\n  color: #FFFFFF;\n  text-align: left;\n  width: 60px;\n  height: 60px;\n  border-radius: 60px;\n  background: url(" + escape(__webpack_require__(65)) + ") no-repeat;\n  cursor: pointer;\n}\n.reback-top[data-v-246fa73c]:hover {\n    background-color: rgba(0, 0, 0, 0.2);\n}\n", ""]);
...
module.exports = "data:image/png;base64,"
  ...
  return _c("div", { staticClass: "footer-wraper" }, [
    _c("div", { staticClass: "footer" }, [
      _c("div", { staticClass: "footer_content" }, [
        _c("span", { staticClass: "footer_left" }, [
          _vm._v("Copyright©2013-2018 深圳市仕瑞达自动化设备有限公司")
        ]),
        _vm._v(" "),
        _vm.gotopshow
          ? _c("span", {
              staticClass: "reback-top",
              on: { click: _vm.goToTopClick }
            })
          : _vm._e(),
        _vm._v(" "),
        _c(
